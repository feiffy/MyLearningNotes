...
from myweather import getweather
...
def text_reply(msg):
    ...
    elif msg['Text'] in [u'南京', u'南通', u'青岛', u'济南']:
        return getweather(msg['Text'])
    elif u'在吗' in msg['Text']:
        return u'自动回复：在的，请问有什么事吗？'
    elif u'师父' in msg['Text']:
        return u'嗯？'
    else:
